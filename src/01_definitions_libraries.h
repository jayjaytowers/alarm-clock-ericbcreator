...
#ifdef DAYLIGHTINFO
  char d2d_City[] = "Buenos Aires";             // @EB-setup City name
  float d2d_lattitude = -34.61315;              // @EB-setup
  float d2d_longitude = -58.37723;               // @EB-setup
  int d2d_timezone = -3;                       // @EB-setup UTC timezone offset
#endif
